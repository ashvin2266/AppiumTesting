...
public class ValidatingMobileLongPressGesture extends BaseTest{
...
//				"text", "$160.97"));
		...
		/*
		 * From Here we validating long press mobile gestures and click on checkbox and send order
		 * 
		 */
	 WebElement ele= driver.findElement(By.id("com.androidsample.generalstore:id/termsButton"));
	        longPress(ele);
	        
	        String popupTextHeading=driver.findElement(By.id("com.androidsample.generalstore:id/alertTitle")).getText();
	        Assert.assertEquals(popupTextHeading,"Terms Of Conditions");
